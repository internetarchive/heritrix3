 ...
 * @author Gojomo
 * 
 * {@link PublicSuffixes2} is a complete rewrite of {@link PublicSuffixes} for generating
 * more efficient regular expression. It may be even possible to write a light-weight,
 * thread-safe matcher based on this class.
 * @author Kenji Nagahashi 
 */
public class PublicSuffixes2 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        if (args.length == 0 || "=".equals(args[0])) {
            // use bundled list
            is = PublicSuffixes2.class.getClassLoader().getResourceAsStream(
        ...
        if (topmostAssignedSurtPrefixRegex == null) {
            ...
            try {
                BufferedReader reader = new BufferedReader(new InputStreamReader(
                        PublicSuffixes2.class.getClassLoader().getResourceAsStream(
