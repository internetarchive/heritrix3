 ...
 * treshold.
 */
public class NotExceedsDocumentLengthThresholdDecideRule
extends PredicatedDecideRule {
    ...
    private static final Logger logger = Logger.
    	getLogger(NotExceedsDocumentLengthThresholdDecideRule.class.getName());
    ...
    public NotExceedsDocumentLengthThresholdDecideRule() {
    }
